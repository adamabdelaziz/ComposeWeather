...
class WeatherFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestPermissionLauncher =
            registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted: Boolean ->
                if (isGranted) {
                    settingsViewModel.onLocationSettingsSelected(true)
                    locationer = true
                    Timber.d("Permission granted")
                } else {
                    //Probably
                    settingsViewModel.onLocationSettingsSelected(false)
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            ...
            val locationLiveData = settingsViewModel.location
            ...
            setContent {
                ...
                Timber.d(locationState.toString() + " locationState in setContent")
